...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Users/klosey/lab_3B/lab_3B.cache/wt [current_project]
  set src_rc [catch { 
    puts "source C:/Users/klosey/Desktop/test1.tcl"
    source C:/Users/klosey/Desktop/test1.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script C:/Users/klosey/Desktop/test1.tcl failed"
    return -code error
  }
