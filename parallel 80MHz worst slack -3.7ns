...
input                          M_AXIS_TREADY;  // Connected slave device is ready to accept data out
   ...
   (* max_fanout = 50 *) reg signed [31:0] input_number[0:27][0:12];
   (* max_fanout = 50 *) reg signed [31:0] weightih[0:13][0:9];
   (* max_fanout = 50 *) reg signed [31:0] weightho[0:10];
   (* max_fanout = 50 *) reg signed [31:0] hidden_layer[0:27][0:9];
   (* max_fanout = 50 *) reg signed [31:0] tempH[0:12];
   (* max_fanout = 50 *) reg signed [31:0] tempO[0:9];
   (* max_fanout = 50 *) reg signed [31:0] output_number[0:28];
